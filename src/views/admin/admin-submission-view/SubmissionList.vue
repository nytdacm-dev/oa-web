  ...
  },
  {
    ...
    render(row) {
      switch (row.oj) {
        ...
        case 'nowcoder':
          return (
            <Link href={`https://ac.nowcoder.com/acm/problem/${row.remoteProblemId}`}>
              {row.name}
            </Link>
          )
        case 'atcoder':
          return (
            <Link href={`https://atcoder.jp/contests/${row.contestId}/tasks/${row.remoteProblemId}`}>
              请进入题目内部查看！
            </Link>
          )
        default:
  ...
  },
  {
    ...
    render(row) {
      switch (row.oj) {
        ...
        case 'nowcoder':
          return (
            <Link href="https://ac.nowcoder.com">
              牛客
            </Link>
          )
        case 'atcoder':
